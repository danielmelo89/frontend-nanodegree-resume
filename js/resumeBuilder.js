...
var projects = {
	"projects" : [
	{
		...
		"dates" : "September 2012 to Current",
		...
		"image" : ["http://www.portalprogramas.com.br/assets/img/logo.png"]
	}
	]
}
...
projects.display = function() {
	for (project in projects.projects) {
		...
		var formattedPImage = HTMLprojectImage.replace("%data%", projects.projects[project].image);
